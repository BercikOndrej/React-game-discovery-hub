...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-gray-300 duration-500',
  {
    variants: {
      variant: {
        default:
          'bg-gray-900 text-gray-50 shadow hover:bg-gray-700 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90',
        destructive:
          'bg-red-500 text-gray-50 shadow-sm hover:bg-red-500/90 dark:bg-red-900 dark:text-gray-50 dark:hover:bg-red-900/90',
        outline:
          'border border-gray-900 bg-gray-50 text-gray-700 hover:bg-gray-700 hover:text-gray-50 shadow-md dark:text-gray-50 dark:border-gray-50 dark:bg-gray-700 hover:dark:bg-gray-50 hover:dark:text-gray-700',
        secondary:
